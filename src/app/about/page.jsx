...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-24 md:px-25 px-4 bg-white">
        <motion.div
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
      ...
      >
        ...
        >
          ...
          <Link href="/solutions">
            <Button className="bg-primary lg:mt-3 text-white hover:text-ring hover:bg-purple-200 font-semibold px-8 py-8 w-65 rounded-xl capitalize text-sm tracking-wide">
              View Our Solutions
